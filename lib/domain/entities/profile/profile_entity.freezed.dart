...
mixin _$ProfileEntity {
 ...
 String get pubkey;// hex public key — matches Nostr event pubkey
 String? get name; String? get username; String? get about; String? get avatarUrl; String? get nip05; DateTime get updatedAt; bool get isOwn;// true = logged-in user's profile, never evicted
...
@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,pubkey,name,username,about,avatarUrl,nip05,updatedAt,isOwn,lastSeenAt);

@override
String toString() {
  return 'ProfileEntity(pubkey: $pubkey, name: $name, username: $username, about: $about, avatarUrl: $avatarUrl, nip05: $nip05, updatedAt: $updatedAt, isOwn: $isOwn, lastSeenAt: $lastSeenAt)';
}
...
@useResult
$Res call({
 String pubkey, String? name, String? username, String? about, String? avatarUrl, String? nip05, DateTime updatedAt, bool isOwn, DateTime? lastSeenAt
});
...
/// Create a copy of ProfileEntity
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? pubkey = null,Object? name = freezed,Object? username = freezed,Object? about = freezed,Object? avatarUrl = freezed,Object? nip05 = freezed,Object? updatedAt = null,Object? isOwn = null,Object? lastSeenAt = freezed,}) {
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( String pubkey,  String? name,  String? username,  String? about,  String? avatarUrl,  String? nip05,  DateTime updatedAt,  bool isOwn,  DateTime? lastSeenAt)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _ProfileEntity() when $default != null:
return $default(_that.pubkey,_that.name,_that.username,_that.about,_that.avatarUrl,_that.nip05,_that.updatedAt,_that.isOwn,_that.lastSeenAt);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( String pubkey,  String? name,  String? username,  String? about,  String? avatarUrl,  String? nip05,  DateTime updatedAt,  bool isOwn,  DateTime? lastSeenAt)  $default,) {final _that = this;
switch (_that) {
case _ProfileEntity():
return $default(_that.pubkey,_that.name,_that.username,_that.about,_that.avatarUrl,_that.nip05,_that.updatedAt,_that.isOwn,_that.lastSeenAt);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( String pubkey,  String? name,  String? username,  String? about,  String? avatarUrl,  String? nip05,  DateTime updatedAt,  bool isOwn,  DateTime? lastSeenAt)?  $default,) {final _that = this;
switch (_that) {
case _ProfileEntity() when $default != null:
return $default(_that.pubkey,_that.name,_that.username,_that.about,_that.avatarUrl,_that.nip05,_that.updatedAt,_that.isOwn,_that.lastSeenAt);case _:
  return null;
...
class _ProfileEntity implements ProfileEntity {
  const _ProfileEntity({required this.pubkey, this.name, this.username, this.about, this.avatarUrl, this.nip05, required this.updatedAt, required this.isOwn, this.lastSeenAt});
  factory _ProfileEntity.fromJson(Map<String, dynamic> json) => _$ProfileEntityFromJson(json);

@override final  String pubkey;
// hex public key — matches Nostr event pubkey
...
// true = logged-in user's profile, never evicted
...
/// Create a copy of ProfileEntity
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? pubkey = null,Object? name = freezed,Object? username = freezed,Object? about = freezed,Object? avatarUrl = freezed,Object? nip05 = freezed,Object? updatedAt = null,Object? isOwn = null,Object? lastSeenAt = freezed,}) {
